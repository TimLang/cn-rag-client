...
#line 163 "src\\auto\\XSTools\\win32\\wrapper.c"
...
#line 30 "src\\\\auto\\\\XSTools\\\\win32\\\\wrapper.xs"
		char *op = NULL;
#line 222 "src\\auto\\XSTools\\win32\\wrapper.c"
...
#line 227 "src\\auto\\XSTools\\win32\\wrapper.c"
...
#line 41 "src\\\\auto\\\\XSTools\\\\win32\\\\wrapper.xs"
		HANDLE toolhelp;
		PROCESSENTRY32 pe;
#line 246 "src\\auto\\XSTools\\win32\\wrapper.c"
...
#line 265 "src\\auto\\XSTools\\win32\\wrapper.c"
	PUTBACK;
	return;
    }
}
...
#line 284 "src\\auto\\XSTools\\win32\\wrapper.c"
    }
    XSRETURN_EMPTY;
}
...
#line 302 "src\\auto\\XSTools\\win32\\wrapper.c"
    }
    XSRETURN_EMPTY;
}
...
#line 323 "src\\auto\\XSTools\\win32\\wrapper.c"
	XSprePUSH; PUSHu((UV)RETVAL);
    }
    XSRETURN(1);
}
...
#line 122 "src\\\\auto\\\\XSTools\\\\win32\\\\wrapper.xs"
		DWORD old;
#line 415 "src\\auto\\XSTools\\win32\\wrapper.c"
...
#line 422 "src\\auto\\XSTools\\win32\\wrapper.c"
	XSprePUSH; PUSHu((UV)RETVAL);
    }
    XSRETURN(1);
}
...
#line 138 "src\\\\auto\\\\XSTools\\\\win32\\\\wrapper.xs"
		DWORD bytesRead;
		LPVOID buffer;
#line 446 "src\\auto\\XSTools\\win32\\wrapper.c"
#line 141 "src\\\\auto\\\\XSTools\\\\win32\\\\wrapper.xs"
		...
		free(buffer);
#line 455 "src\\auto\\XSTools\\win32\\wrapper.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
#line 157 "src\\\\auto\\\\XSTools\\\\win32\\\\wrapper.xs"
		...
		STRLEN dwSize;
		DWORD bytesWritten;
#line 482 "src\\auto\\XSTools\\win32\\wrapper.c"
...
#line 494 "src\\auto\\XSTools\\win32\\wrapper.c"
	XSprePUSH; PUSHu((UV)RETVAL);
    }
    XSRETURN(1);
}
...
#line 512 "src\\auto\\XSTools\\win32\\wrapper.c"
    }
    XSRETURN_EMPTY;
}
...
#line 553 "src\\auto\\XSTools\\win32\\wrapper.c"
    }
    XSRETURN_EMPTY;
}
...
#line 577 "src\\auto\\XSTools\\win32\\wrapper.c"
    }
    XSRETURN_EMPTY;
}
...
#line 613 "src\\auto\\XSTools\\win32\\wrapper.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
#line 263 "src\\\\auto\\\\XSTools\\\\win32\\\\wrapper.xs"
	WCHAR buffer[1024];
	DWORD size;
#line 671 "src\\auto\\XSTools\\win32\\wrapper.c"
...
#line 688 "src\\auto\\XSTools\\win32\\wrapper.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
