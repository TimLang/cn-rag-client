...
sub PrepareKeys() {
	#modify by jackywei 20130420
	#K
	$enc_val1 = Math::BigInt->new(sprintf("0x%08x",RSK::GetKey4EncVal(1)));
	# M
	$enc_val3 = Math::BigInt->new(sprintf("0x%08x",RSK::GetKey4EncVal(3)));
	# A
	$enc_val2 = Math::BigInt->new(sprintf("0x%08x",RSK::GetKey4EncVal(2)));
	#modify end
}
