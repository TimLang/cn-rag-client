...
#line 163 "srcXS\\win32\\wrapper.c"
...
;
	int	RETVAL;
	dXSTARG;
#line 30 "srcXS\\\\win32\\\\wrapper.xs"
		char *op = NULL;
#line 222 "srcXS\\win32\\wrapper.c"
#line 32 "srcXS\\\\win32\\\\wrapper.xs"
		if (operation && SvOK (operation))
			op = SvPV_nolen (operation);
		RETVAL = ((int) ShellExecute((HWND) handle, op, file, NULL, NULL, SW_NORMAL)) == 42;
#line 227 "srcXS\\win32\\wrapper.c"
...
XS_EUPXS(XS_Utils__Win32_listProcesses)
{
    ...
    SP -= items;
    {
#line 41 "srcXS\\\\win32\\\\wrapper.xs"
		HANDLE toolhelp;
		PROCESSENTRY32 pe;
#line 246 "srcXS\\win32\\wrapper.c"
#line 44 "srcXS\\\\win32\\\\wrapper.xs"
...
#line 265 "srcXS\\win32\\wrapper.c"
	PUTBACK;
	return;
    }
}
...
;
#line 66 "srcXS\\\\win32\\\\wrapper.xs"
	sndPlaySound(NULL, SND_ASYNC);
	sndPlaySound(file, SND_ASYNC | SND_NODEFAULT);
#line 284 "srcXS\\win32\\wrapper.c"
    }
    XSRETURN_EMPTY;
}
...
;
#line 73 "srcXS\\\\win32\\\\wrapper.xs"
	if (GetActiveWindow() != (HWND) handle)
		FlashWindow((HWND) handle, TRUE);
#line 302 "srcXS\\win32\\wrapper.c"
    }
    XSRETURN_EMPTY;
}
...
;
	unsigned long	RETVAL;
	dXSTARG;
#line 81 "srcXS\\\\win32\\\\wrapper.xs"
		RETVAL = ((DWORD) OpenProcess((DWORD)Access, 0, (DWORD)ProcID));
#line 323 "srcXS\\win32\\wrapper.c"
	XSprePUSH; PUSHu((UV)RETVAL);
    }
    XSRETURN(1);
}
...
XS_EUPXS(XS_Utils__Win32_SystemInfo_PageSize)
{
	...
	unsigned long	RETVAL;
	dXSTARG;
#line 88 "srcXS\\\\win32\\\\wrapper.xs"
		SYSTEM_INFO si;
#line 341 "srcXS\\win32\\wrapper.c"
#line 90 "srcXS\\\\win32\\\\wrapper.xs"
		GetSystemInfo((LPSYSTEM_INFO)&si);
		RETVAL = si.dwPageSize;
#line 345 "srcXS\\win32\\wrapper.c"
	XSprePUSH; PUSHu((UV)RETVAL);
    }
    XSRETURN(1);
}
...
XS_EUPXS(XS_Utils__Win32_SystemInfo_MinAppAddress)
{
	...
	unsigned long	RETVAL;
	dXSTARG;
#line 98 "srcXS\\\\win32\\\\wrapper.xs"
		SYSTEM_INFO si;
#line 363 "srcXS\\win32\\wrapper.c"
#line 100 "srcXS\\\\win32\\\\wrapper.xs"
		GetSystemInfo((LPSYSTEM_INFO)&si);
		RETVAL = ((DWORD) si.lpMinimumApplicationAddress);
#line 367 "srcXS\\win32\\wrapper.c"
	XSprePUSH; PUSHu((UV)RETVAL);
    }
    XSRETURN(1);
}
...
XS_EUPXS(XS_Utils__Win32_SystemInfo_MaxAppAddress)
{
	...
	unsigned long	RETVAL;
	dXSTARG;
#line 108 "srcXS\\\\win32\\\\wrapper.xs"
		SYSTEM_INFO si;
#line 385 "srcXS\\win32\\wrapper.c"
#line 110 "srcXS\\\\win32\\\\wrapper.xs"
		GetSystemInfo((LPSYSTEM_INFO)&si);
		RETVAL = ((DWORD) si.lpMaximumApplicationAddress);
#line 389 "srcXS\\win32\\wrapper.c"
	XSprePUSH; PUSHu((UV)RETVAL);
    }
    XSRETURN(1);
}
...
;
	unsigned long	RETVAL;
	dXSTARG;
#line 122 "srcXS\\\\win32\\\\wrapper.xs"
		DWORD old;
#line 415 "srcXS\\win32\\wrapper.c"
#line 124 "srcXS\\\\win32\\\\wrapper.xs"
		if (0 == VirtualProtectEx((HANDLE)ProcHND, (LPVOID)lpAddr, (SIZE_T)dwSize, (DWORD)dwProtection, (PDWORD)&old)) {
			RETVAL = 0;
		} else {
			RETVAL = old;
		}
#line 422 "srcXS\\win32\\wrapper.c"
	XSprePUSH; PUSHu((UV)RETVAL);
    }
    XSRETURN(1);
}
...
;
	SV *	RETVAL;
#line 138 "srcXS\\\\win32\\\\wrapper.xs"
		DWORD bytesRead;
		LPVOID buffer;
#line 446 "srcXS\\win32\\wrapper.c"
#line 141 "srcXS\\\\win32\\\\wrapper.xs"
		...
		free(buffer);
#line 455 "srcXS\\win32\\wrapper.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
;
	unsigned long	RETVAL;
	dXSTARG;
#line 157 "srcXS\\\\win32\\\\wrapper.xs"
		LPCVOID lpBuffer;
		STRLEN dwSize;
		DWORD bytesWritten;
#line 482 "srcXS\\win32\\wrapper.c"
#line 161 "srcXS\\\\win32\\\\wrapper.xs"
		if (0 == SvPOK(svData)) {
			RETVAL = 0;
		} else {
...
#line 494 "srcXS\\win32\\wrapper.c"
	XSprePUSH; PUSHu((UV)RETVAL);
    }
    XSRETURN(1);
}
...
;
#line 178 "srcXS\\\\win32\\\\wrapper.xs"
		CloseHandle((HANDLE)Handle);
#line 512 "srcXS\\win32\\wrapper.c"
    }
    XSRETURN_EMPTY;
}
...
XS_EUPXS(XS_Utils__Win32_printConsole)
{
	...
	SV *	message = ST(0)
;
#line 188 "srcXS\\\\win32\\\\wrapper.xs"
...
#line 553 "srcXS\\win32\\wrapper.c"
    }
    XSRETURN_EMPTY;
}
...
XS_EUPXS(XS_Utils__Win32_setConsoleTitle)
{
	...
	SV *	title = ST(0)
;
#line 201 "srcXS\\\\win32\\\\wrapper.xs"
	if (title && SvOK (title)) {
		char *str;
		STRLEN len;
...
#line 577 "srcXS\\win32\\wrapper.c"
    }
    XSRETURN_EMPTY;
}
...
;
	SV *	RETVAL;
#line 215 "srcXS\\\\win32\\\\wrapper.xs"
	if (str && SvOK(str)) {
		char *s, *result;
		STRLEN len;
...
#line 613 "srcXS\\win32\\wrapper.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
;
	SV *	RETVAL;
#line 240 "srcXS\\\\win32\\\\wrapper.xs"
	if (str && SvOK(str)) {
		char *s, *result;
		STRLEN len;
		unsigned int result_len;
...
#line 650 "srcXS\\win32\\wrapper.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
;
	SV *	RETVAL;
#line 263 "srcXS\\\\win32\\\\wrapper.xs"
	WCHAR buffer[1024];
	DWORD size;
#line 671 "srcXS\\win32\\wrapper.c"
#line 266 "srcXS\\\\win32\\\\wrapper.xs"
...
#line 688 "srcXS\\win32\\wrapper.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
