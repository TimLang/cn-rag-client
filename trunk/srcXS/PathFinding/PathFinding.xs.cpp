...
#line 1 "srcXS\\\\PathFinding\\\\PathFinding.xs"
#include <stdlib.h>
#include "EXTERN.h"
#include "perl.h"
#include "XSUB.h"
...
#line 31 "srcXS\\PathFinding\\PathFinding.c"
...
#line 173 "srcXS\\PathFinding\\PathFinding.c"
...
XS_EUPXS(XS_PathFinding_create)
{
    ...
    {
	PathFinding	RETVAL;
#line 29 "srcXS\\\\PathFinding\\\\PathFinding.xs"
		RETVAL = CalcPath_new ();
#line 185 "srcXS\\PathFinding\\PathFinding.c"
	ST(0) = sv_newmortal();
...
;
#line 46 "srcXS\\\\PathFinding\\\\PathFinding.xs"
		unsigned char *real_weights = NULL;
		char *real_map = NULL;
		pos *start, *dest;
		session = (PathFinding) 0; /* shut up compiler warning */
#line 225 "srcXS\\PathFinding\\PathFinding.c"
...
;
#line 51 "srcXS\\\\PathFinding\\\\PathFinding.xs"
		if (session->map_sv)
...
#line 274 "srcXS\\PathFinding\\PathFinding.c"
    }
    XSRETURN_EMPTY;
}
...
XS_EUPXS(XS_PathFinding_run)
{
	...
	SV *	r_array = ST(1)
;
#line 96 "srcXS\\\\PathFinding\\\\PathFinding.xs"
		int status;
#line 292 "srcXS\\PathFinding\\PathFinding.c"
	int	RETVAL;
	dXSTARG;
	...
	session = (PathFinding) tmp;
		...
		croak("session is not of type PathFinding")
;
#line 98 "srcXS\\\\PathFinding\\\\PathFinding.xs"
...
#line 334 "srcXS\\PathFinding\\PathFinding.c"
...
XS_EUPXS(XS_PathFinding_runref)
{
    ...
    {
	PathFinding	session;
#line 135 "srcXS\\\\PathFinding\\\\PathFinding.xs"
		int status;
#line 351 "srcXS\\PathFinding\\PathFinding.c"
	SV *	RETVAL;
	...
	session = (PathFinding) tmp;
		...
		croak("session is not of type PathFinding")
;
#line 137 "srcXS\\\\PathFinding\\\\PathFinding.xs"
		status = CalcPath_pathStep (session);
		if (status < 0) {
			XSRETURN_UNDEF;
...
#line 385 "srcXS\\PathFinding\\PathFinding.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
XS_EUPXS(XS_PathFinding_runstr)
{
    ...
    {
	PathFinding	session;
#line 167 "srcXS\\\\PathFinding\\\\PathFinding.xs"
		int status;
#line 403 "srcXS\\PathFinding\\PathFinding.c"
	SV *	RETVAL;
	...
	session = (PathFinding) tmp;
		...
		croak("session is not of type PathFinding")
;
#line 169 "srcXS\\\\PathFinding\\\\PathFinding.xs"
		status = CalcPath_pathStep (session);
		if (status < 0) {
			XSRETURN_UNDEF;
		} else if (status > 0) {
...
#line 422 "srcXS\\PathFinding\\PathFinding.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
XS_EUPXS(XS_PathFinding_runcount)
{
    ...
    {
	PathFinding	session;
#line 184 "srcXS\\\\PathFinding\\\\PathFinding.xs"
		int status;
#line 440 "srcXS\\PathFinding\\PathFinding.c"
	int	RETVAL;
	dXSTARG;
	...
	session = (PathFinding) tmp;
		...
		croak("session is not of type PathFinding")
;
#line 186 "srcXS\\\\PathFinding\\\\PathFinding.xs"
		status = CalcPath_pathStep (session);
		if (status < 0)
			RETVAL = -1;
		else if (status > 0)
			...
			RETVAL = 0;
#line 459 "srcXS\\PathFinding\\PathFinding.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS_EUPXS(XS_PathFinding_DESTROY)
{
    ...
    {
	PathFinding	session;
#line 200 "srcXS\\\\PathFinding\\\\PathFinding.xs"
		session = (PathFinding) 0; /* shut up compiler warning */
#line 476 "srcXS\\PathFinding\\PathFinding.c"
	...
	session = (PathFinding) tmp;
		...
		croak("session is not of type PathFinding")
;
#line 202 "srcXS\\\\PathFinding\\\\PathFinding.xs"
		if (session->map_sv)
			SvREFCNT_dec (session->map_sv);
		if (session->weight_sv)
			SvREFCNT_dec (session->weight_sv);
		CalcPath_destroy (session);
#line 491 "srcXS\\PathFinding\\PathFinding.c"
    }
    XSRETURN_EMPTY;
}
