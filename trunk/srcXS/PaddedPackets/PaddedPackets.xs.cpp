...
#line 1 "srcXS\\\\PaddedPackets\\\\PaddedPackets.xs"
#include "EXTERN.h"
#include "perl.h"
#include "XSUB.h"
...
#line 26 "srcXS\\PaddedPackets\\PaddedPackets.c"
...
#line 168 "srcXS\\PaddedPackets\\PaddedPackets.c"
...
;
	unsigned int	RETVAL;
	dXSTARG;
#line 38 "srcXS\\\\PaddedPackets\\\\PaddedPackets.xs"
	ctrl = ctrl + 1; // Shut up compiler warning.
	engine.addKey(targetId);
	engine.addKey(7);
	RETVAL = engine.encode((byte *) packet, sitPacketID);
#line 215 "srcXS\\PaddedPackets\\PaddedPackets.c"
	XSprePUSH; PUSHu((UV)RETVAL);
    }
    XSRETURN(1);
}
...
;
	unsigned int	RETVAL;
	dXSTARG;
#line 52 "srcXS\\\\PaddedPackets\\\\PaddedPackets.xs"
	engine.addKey(skillLv);
	engine.addKey(skillId);
	engine.addKey(targetId);
	RETVAL = engine.encode((byte *) packet, skillPacketID);
#line 244 "srcXS\\PaddedPackets\\PaddedPackets.c"
	XSprePUSH; PUSHu((UV)RETVAL);
    }
    XSRETURN(1);
}
...
;
#line 63 "srcXS\\\\PaddedPackets\\\\PaddedPackets.xs"
	engine.setMapSync(mapSync);
#line 262 "srcXS\\PaddedPackets\\PaddedPackets.c"
    }
    XSRETURN_EMPTY;
}
...
;
#line 69 "srcXS\\\\PaddedPackets\\\\PaddedPackets.xs"
	engine.setSync(sync);
#line 279 "srcXS\\PaddedPackets\\PaddedPackets.c"
    }
    XSRETURN_EMPTY;
}
...
;
#line 75 "srcXS\\\\PaddedPackets\\\\PaddedPackets.xs"
	engine.setAccId(accountId);
#line 296 "srcXS\\PaddedPackets\\PaddedPackets.c"
    }
    XSRETURN_EMPTY;
}
...
;
#line 83 "srcXS\\\\PaddedPackets\\\\PaddedPackets.xs"
	engine.setPacket((byte *) packet, packetLength);
	lastTargetId = targetId;
#line 318 "srcXS\\PaddedPackets\\PaddedPackets.c"
    }
    XSRETURN_EMPTY;
}
...
;
#line 91 "srcXS\\\\PaddedPackets\\\\PaddedPackets.xs"
	sitPacketID = sit;
	skillPacketID = skill;
#line 338 "srcXS\\PaddedPackets\\PaddedPackets.c"
    }
    XSRETURN_EMPTY;
}
...
;
#line 99 "srcXS\\\\PaddedPackets\\\\PaddedPackets.xs"
	engine.decode((byte *) packet, keyCount);
#line 357 "srcXS\\PaddedPackets\\PaddedPackets.c"
    }
    XSRETURN_EMPTY;
}
...
;
	unsigned int	RETVAL;
	dXSTARG;
#line 105 "srcXS\\\\PaddedPackets\\\\PaddedPackets.xs"
	RETVAL = engine.getKey(keyIndex);
#line 376 "srcXS\\PaddedPackets\\PaddedPackets.c"
	XSprePUSH; PUSHu((UV)RETVAL);
    }
    XSRETURN(1);
}
