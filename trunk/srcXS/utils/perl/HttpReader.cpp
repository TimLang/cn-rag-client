...
#line 1 "srcXS\\\\utils\\\\perl\\\\HttpReader.xs"
...
#line 23 "srcXS\\utils\\perl\\HttpReader.c"
...
#line 165 "srcXS\\utils\\perl\\HttpReader.c"
...
;
#line 22 "srcXS\\\\utils\\\\perl\\\\HttpReader.xs"
	RETVAL = (char *) THIS->getError();
#line 213 "srcXS\\utils\\perl\\HttpReader.c"
...
;
#line 31 "srcXS\\\\utils\\\\perl\\\\HttpReader.xs"
	STRLEN dummy;
	char *buffer;
#line 245 "srcXS\\utils\\perl\\HttpReader.c"
#line 34 "srcXS\\\\utils\\\\perl\\\\HttpReader.xs"
...
#line 257 "srcXS\\utils\\perl\\HttpReader.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
;
#line 51 "srcXS\\\\utils\\\\perl\\\\HttpReader.xs"
	RETVAL = (char *) THIS->getData(len);
#line 286 "srcXS\\utils\\perl\\HttpReader.c"
...
XS_EUPXS(XS_StdHttpReader_init)
{
    ...
    if (items != 0)
       croak_xs_usage(cv,  "");
    {
#line 68 "srcXS\\\\utils\\\\perl\\\\HttpReader.xs"
	StdHttpReader::init();
#line 353 "srcXS\\utils\\perl\\HttpReader.c"
    }
    XSRETURN_EMPTY;
}
...
#line 75 "srcXS\\\\utils\\\\perl\\\\HttpReader.xs"
	if (postData == NULL) {
...
#line 391 "srcXS\\utils\\perl\\HttpReader.c"
	ST(0) = sv_newmortal();
...
#line 97 "srcXS\\\\utils\\\\perl\\\\HttpReader.xs"
	list<const char *> urls_list;
	I32 i, len;
#line 429 "srcXS\\utils\\perl\\HttpReader.c"
#line 100 "srcXS\\\\utils\\\\perl\\\\HttpReader.xs"
	len = av_len(urls);
	for (i = 0; i <= len; i++) {
		SV **item;
...
#line 442 "srcXS\\utils\\perl\\HttpReader.c"
	ST(0) = sv_newmortal();
	sv_setref_pv( ST(0), CLASS, (void*)RETVAL );
    }
    XSRETURN(1);
