...
#line 1 "srcXS\\\\utils\\\\perl\\\\Benchmark.xs"
...
#line 113 "srcXS\\utils\\perl\\Benchmark.c"
...
#line 255 "srcXS\\utils\\perl\\Benchmark.c"
...
XS_EUPXS(XS_Benchmark_init)
{
    ...
    if (items != 0)
       croak_xs_usage(cv,  "");
    {
#line 109 "srcXS\\\\utils\\\\perl\\\\Benchmark.xs"
...
#line 273 "srcXS\\utils\\perl\\Benchmark.c"
    }
    XSRETURN_EMPTY;
}
...
;
#line 122 "srcXS\\\\utils\\\\perl\\\\Benchmark.xs"
	benchmark.begin(domain);
#line 290 "srcXS\\utils\\perl\\Benchmark.c"
    }
    XSRETURN_EMPTY;
}
...
XS_EUPXS(XS_Benchmark_end)
{
	...
	char *	domain = (char *)SvPV_nolen(ST(0))
;
#line 128 "srcXS\\\\utils\\\\perl\\\\Benchmark.xs"
	benchmark.end(domain);
#line 307 "srcXS\\utils\\perl\\Benchmark.c"
    }
    XSRETURN_EMPTY;
}
...
XS_EUPXS(XS_Benchmark_getResults)
{
    ...
    {
	SV *	RETVAL;
#line 133 "srcXS\\\\utils\\\\perl\\\\Benchmark.xs"
...
#line 337 "srcXS\\utils\\perl\\Benchmark.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
;
	double	RETVAL;
	dXSTARG;
#line 155 "srcXS\\\\utils\\\\perl\\\\Benchmark.xs"
	RETVAL = clocktime / (double) CLOCKS_PER_SEC;
#line 358 "srcXS\\utils\\perl\\Benchmark.c"
