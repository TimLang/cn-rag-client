...
#line 1 "srcXS\\\\utils\\\\perl\\\\Whirlpool.xs"
...
#line 20 "srcXS\\utils\\perl\\Whirlpool.c"
...
#line 162 "srcXS\\utils\\perl\\Whirlpool.c"
...
;
	WP_Struct *	RETVAL;
#line 17 "srcXS\\\\utils\\\\perl\\\\Whirlpool.xs"
	RETVAL = WP_Create();
#line 176 "srcXS\\utils\\perl\\Whirlpool.c"
	ST(0) = sv_newmortal();
...
;
#line 25 "srcXS\\\\utils\\\\perl\\\\Whirlpool.xs"
	WP_Init(wp);
#line 202 "srcXS\\utils\\perl\\Whirlpool.c"
    }
    XSRETURN_EMPTY;
}
...
;
#line 32 "srcXS\\\\utils\\\\perl\\\\Whirlpool.xs"
...
#line 234 "srcXS\\utils\\perl\\Whirlpool.c"
    }
    XSRETURN_EMPTY;
}
...
;
#line 44 "srcXS\\\\utils\\\\perl\\\\Whirlpool.xs"
	unsigned char hash[WP_DIGEST_SIZE];
#line 259 "srcXS\\utils\\perl\\Whirlpool.c"
#line 46 "srcXS\\\\utils\\\\perl\\\\Whirlpool.xs"
	WP_Finalize(wp, hash);
	RETVAL = newSVpvn((const char *) hash, WP_DIGEST_SIZE);
#line 263 "srcXS\\utils\\perl\\Whirlpool.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
;
#line 55 "srcXS\\\\utils\\\\perl\\\\Whirlpool.xs"
	WP_Free(wp);
#line 289 "srcXS\\utils\\perl\\Whirlpool.c"
    }
    XSRETURN_EMPTY;
}
